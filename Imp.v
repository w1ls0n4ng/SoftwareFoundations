...
Proof.
  ...
  - intros. induction H;
    try reflexivity;
    try (simpl; rewrite aeval_iff_aevalR in H; rewrite aeval_iff_aevalR in H0;
...
(** For the definitions of evaluation for arithmetic and boolean
    ...
    definitions is mainly a matter of taste: eitherFixpoint aeval (a : aexp) : nat :=
  match a with
  | ANum n => n
  | APlus  a1 a2 => (aeval a1) + (aeval a2)
  | AMinus a1 a2 => (aeval a1) - (aeval a2)
...
Proof.
  ...
  - intros. induction c.
    + apply nw_skip.
    + apply nw_asgn.
    + simpl in H. apply andb_true_iff in H. destruct H. apply nw_seq.
      * apply IHc1. apply H.
      * apply IHc2. apply H0.
    + simpl in H. apply andb_true_iff in H. destruct H. apply nw_if.
      * apply IHc1. apply H.
      * apply IHc2. apply H0.
    + simpl in H. discriminate H.
  - intros. 
    induction c; try reflexivity;
    try (simpl; inversion H; apply andb_true_iff; split).
    + apply IHc1. apply H2.
    + apply IHc2. apply H3.
    + apply IHc1. apply H2.
    + apply IHc2. apply H4.
...
Proof.
  ...
  - destruct (IHno_whilesR1 st). destruct (IHno_whilesR2 x). exists x0.
